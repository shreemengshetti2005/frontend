  ...
  return (
    <section id="projects" className="my-20">
      ...
      <p className="mb-12 max-w-2xl text-gray-700 dark:text-gray-300">
        From AI-driven automation to custom marketplaces, our work helps
        businesses scale smarter. Explore some of the platforms, tools, and
        solutions we've created for our clients and ourselves.
      </p>
