...
export default function LoginPage() {
    ...
    const handleSkip = () => {
        ...
        // Redirect to upload page without authentication
        window.location.href = '/upload';
    };
        ...
        <div className="min-h-screen bg-gray-200 dark:bg-[#111111] flex items-center justify-center px-4 sm:px-6 lg:px-8 mt-8">
            <div className="max-w-md w-full space-y-6">
                ...
                <div className="text-center">
                    <h2 className="text-black dark:text-white text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">
                        Welcome Back, <span className="text-[#7A7FEE]">Explorer</span>
                    </h2>
                    <p className="mt-3 text-gray-600 dark:text-gray-400 text-sm sm:text-base md:text-lg">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#111111] text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#7A7FEE] focus:border-transparent transition-all duration-200"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 pr-12 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#111111] text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#7A7FEE] focus:border-transparent transition-all duration-200"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <input
                                    ...
                                    name="remember-me"
                                    type="checkbox"
                                    className="h-3.5 w-3.5 text-[#7A7FEE] focus:ring-[#7A7FEE] border-gray-300 dark:border-gray-600 rounded"
                                />
                                <label htmlFor="remember-me" className="ml-2 block text-xs text-gray-700 dark:text-gray-300">
                                    Remember me
                                </label>
                            </div>
                            <a href="#" className="text-xs text-[#7A7FEE] hover:text-[#6366f1] transition-colors">
                                Forgot password?
                            </a>
                        </div>
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-[#7A7FEE] hover:bg-[#6366f1] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#7A7FEE] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                        >
                            {isLoading ? (
                                <div className="flex items-center">
