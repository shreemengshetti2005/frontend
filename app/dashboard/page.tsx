...
export default function DashboardPage() {
    ...
    const stats = [
        { label: 'Total Projects', value: '12', change: '+2 this month', positive: true },
        { label: 'Active Files', value: '8', change: '+1 today', positive: true },
        { label: 'Processing Time', value: '2.3h', change: '-0.5h avg', positive: true },
        { label: 'Success Rate', value: '94%', change: '+2% this week', positive: true },
    ];

    const recentFiles = [
        { name: 'Research Paper.pdf', size: '2.4 MB', uploaded: '2 hours ago', status: 'Completed' },
        { name: 'Data Analysis.xlsx', size: '1.8 MB', uploaded: '5 hours ago', status: 'Processing' },
        { name: 'Presentation.pptx', size: '4.2 MB', uploaded: '1 day ago', status: 'Completed' },
        { name: 'Meeting Notes.txt', size: '0.3 MB', uploaded: '2 days ago', status: 'Completed' },
    ];
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                    <div>
                        <h1 className="text-3xl md:text-4xl font-bold text-black dark:text-white mb-2">
                            Welcome to Your <span className="text-[#7A7FEE]">Dashboard</span>
                        </h1>
                        <p className="text-gray-600 dark:text-gray-400">
                            Manage your files and track your project progress
                        </p>
                    </div>
                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <button
                            onClick={() => router.push('/upload')}
                            className="bg-[#7A7FEE] text-white px-6 py-2 rounded-lg hover:bg-[#6366f1] transition-colors"
                        >
                            Upload New File
                        </button>
                        <button
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {stats.map((stat, index) => (
                                <div key={index} className="bg-gray-50 dark:bg-[#1a1a1a] rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                                    ...
                                    <div key={index} className="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                                        <div className="flex items-center space-x-4">
                                            <div className="w-10 h-10 bg-[#7A7FEE]/10 rounded-lg flex items-center justify-center">
                                                <svg className="w-5 h-5 text-[#7A7FEE]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {activeTab === 'files' && (
                    <div className="bg-gray-50 dark:bg-[#1a1a1a] rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <button
                                onClick={() => router.push('/upload')}
                                className="bg-[#7A7FEE] text-white px-4 py-2 rounded-lg hover:bg-[#6366f1] transition-colors text-sm"
                            >
                                Upload New File
                            </button>
                        </div>
                        <div className="space-y-3">
                            {recentFiles.map((file, index) => (
                                <div key={index} className="flex items-center justify-between p-4 bg-white dark:bg-[#111111] rounded-lg border border-gray-200 dark:border-gray-700">
                                    <div className="flex items-center space-x-4">
                                        <div className="w-10 h-10 bg-[#7A7FEE]/10 rounded-lg flex items-center justify-center">
                                            <svg className="w-5 h-5 text-[#7A7FEE]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        ...
                        <div className="bg-gray-50 dark:bg-[#1a1a1a] rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-white dark:bg-[#111111] rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                                    <h4 className="font-medium text-gray-900 dark:text-white mb-2">File Processing</h4>
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm">
                                            <span className="text-gray-600 dark:text-gray-400">PDF Files</span>
                                            <span className="font-medium text-gray-900 dark:text-white">45%</span>
                                        </div>
                                        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                            <div className="bg-[#7A7FEE] h-2 rounded-full" style={{ width: '45%' }}></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-white dark:bg-[#111111] rounded-lg p-4 border border-gray-200 dark:border-gray-700">
