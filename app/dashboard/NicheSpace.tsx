...
export default function NicheSpace({
                                       isClient,
                                   }: NicheSpaceProps) {
    ...
    const referenceSpecies: SpeciesData[] = [
        {
            ...
            description: "A model organism for plants, acting as a primary producer (autotroph).",
        },
        {
            id: "diatom",
            name: "T. pseudonana",
            ...
            description: "A marine diatom, a key photosynthetic organism in ocean food webs.",
        },
        {
            id: "foraminiferan",
            name: "G. siphonifera",
            ...
            description: "A planktonic foraminiferan with a mixotrophic feeding strategy, hosting algal symbionts.",
        },
        {
            id: "paramecium",
            name: "P. tetraurelia",
            ...
            isNovel: false,
            taxonomicGroup: "Chromista",
            description: "A free-living ciliate that feeds on microorganisms, making it a heterotroph.",
        },
        {
            id: "yeast",
            name: "S. cerevisiae",
            ...
            description: "A saprotrophic fungus that absorbs nutrients, classifying it as a heterotroph.",
        },
        {
            id: "sea_urchin",
            name: "S. purpuratus",
            ...
            description: "A marine herbivore that grazes on algae, placing it firmly as a heterotroph.",
        },
        {
            id: "amoeba",
            name: "A. proteus",
            ...
            description: "A classic free-living predator that engulfs its food (phagocytosis).",
        },
    ];
    ...
    const novelSpeciesData: SpeciesData = {
        ...
        description: "A novel deep-sea foraminiferan species identified from eDNA, predicted to be a benthic heterotroph feeding on marine snow.",
    ...
    useEffect(() => {
        ...
        const quadrants = [
            {
                x: 0,
                y: 0,
                width: (xScale(3.5) - xScale(2.0)) * width / (xScale(5.0)-xScale(2.0)) ,
                height: height / 2,
            ...
            },
            {
                ...
                y: 0,
                width: (xScale(5.0) - xScale(3.5)) * width / (xScale(5.0)-xScale(2.0)),
                height: height / 2,
                label: "Heterotroph-Parasitic",
                color: isDarkMode ? "#4a0e0e" : "#fee2e2",
                opacity: isDarkMode ? 0.3 : 0.15,
            },
            {
                x: 0,
                ...
                color: isDarkMode ? "#042f1c" : "#d1fae5",
                opacity: isDarkMode ? 0.3 : 0.15,
            },
            {
                x: (xScale(3.5) - xScale(2.0)) * width / (xScale(5.0)-xScale(2.0)),
                ...
                color: isDarkMode ? "#1e2c58" : "#dbeafe",
                opacity: isDarkMode ? 0.3 : 0.15,
            },
        ];
        ...
        speciesNodes
            ...
            .style("stroke", (d) => (d.isNovel ? (isDarkMode ? "#fca5a5" : "#dc2626") : (isDarkMode ? "#1f2937" : "#ffffff")))
...
`
        ...
        // Add labels for species with dynamic colors based on theme
        speciesNodes
            .append("text")
            ...
            .style("fill", (d) =>
                d.isNovel ? (isDarkMode ? "#fca5a5" : "#dc2626") : (isDarkMode ? "#d1d5db" : "#1f2937")
            )
            .style("pointer-events", "none")
