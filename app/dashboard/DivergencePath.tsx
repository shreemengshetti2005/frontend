...
export default function EvolutionaryTrajectory({
  ...
  const evolutionData: SpeciesNode[] = [
    // Common Ancestral lineage (before divergence)
    {
      ...
      lineage: 0,
      isNovel: false,
      description: "Early ancestral population",
    },
    {
      id: "anc1",
      ...
      lineage: 0,
      isNovel: false,
      description: "Deep-sea ancestral species from Abyssal Plain",
    },
    ...
    // Lineage 1 (Red) - Higher GC content trajectory
    {
      ...
      lineage: 1,
      isNovel: false,
      description: "Adapted to hydrothermal vent conditions",
    },
    {
      id: "sp2",
      name: "Species B",
      ...
      lineage: 1,
      isNovel: false,
      description: "Enhanced thermophilic capabilities",
    },
    {
      id: "novel1",
      name: "Novel",
      ...
      isNovel: true,
      description:
        "Highly divergent thermophilic species - potential new genus",
    },
    ...
    // Lineage 2 (Teal) - Lower GC content trajectory
    {
      ...
      lineage: 2,
      isNovel: false,
      description: "Cold-adapted variant",
    },
    {
      id: "sp4",
      name: "Species D",
      ...
      lineage: 2,
      isNovel: false,
      description: "Shifted to oligotrophic environment",
    },
    {
      id: "sp5",
      name: "Species E",
      ...
      lineage: 2,
      isNovel: false,
      description: "Established in cold seep communities",
    },
    ...
    // Lineage 3 (Yellow) - Stable then rapid shift
    {
      ...
      lineage: 3,
      isNovel: false,
      description: "Maintained ancestral traits",
    },
    {
      id: "sp7",
      name: "Species G",
      ...
      lineage: 3,
      isNovel: false,
      description: "Conservative evolution pattern",
    },
    {
      id: "sp8",
      name: "Species H",
      ...
      lineage: 3,
      isNovel: false,
      description: "Gradual adaptation to seamount habitat",
    },
  ];
  ...
  useEffect(() => {
    ...
    const yScale = d3.scaleLinear().domain([38, 59]).range([height, 0]);
    ...
    lineages.forEach((lineageNum) => {
      const lineageData = evolutionData.filter(
        (d) => d.lineage === lineageNum || d.lineage === 0
      );
      ...
      .on("mouseover", function (event, d) {
        ...
        const tooltip = container
          ...
          .html(
            ...
            ${
              d.isNovel
                ? '<span style="color: #FF6B6B;">★ Novel Species</span>'
                : ""
            }
          `
          )
    ...
    // Add labels for key species with dynamic colors based on theme
    nodes
      .filter((d) => d.isNovel || d.lineage === 0)
      .append("text")
      ...
      .style("fill", (d) =>
        d.isNovel ? "#dc2626" : isDarkMode ? "#d1d5db" : "#1f2937"
      )
      .text((d) => d.name);
    ...
    xAxis
      .selectAll("line, path")
      .style("stroke", isDarkMode ? "#6b7280" : "#6b7280")
