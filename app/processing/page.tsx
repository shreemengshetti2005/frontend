...
const processingSteps = [
    ...
    {
        name: "DNA Clustering & Mapping",
        description: "Clustering sequences and mapping against known/unknown DNA databases",
        icon: Network,
    },
    {
        name: "Mamba Embedding & Similarity Analysis",
        description: "Using deep learning to embed and analyze DNA sequence similarities",
        icon: Brain,
    },
    {
        name: "Taxonomic Classification",
        description: "Identifying species and computing biodiversity metrics using HDBSCAN clustering",
        icon: Microscope,
    },
    {
        name: "Discovery Card & Visualization Generation",
        description: "Creating discovery cards, taxonomy trees, and ecological insights",
        icon: BarChart2,
    },
];
...
const statusMessages = [
    ...
    "Clustering DNA sequences with similarities...",
    "Running Mamba embedding on sequences...",
    "Mapping against known and unknown DNA databases...",
    "Classifying taxonomic units with HDBSCAN...",
    "Computing biodiversity and ecology metrics...",
    "Generating discovery cards and interactive visualizations...",
    "Almost there...",
];
                ...
                <div className="pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-8 px-4">
                    <div className="container mx-auto max-w-4xl text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
                            Running advanced eDNA analysis pipeline with Mamba embedding and HDBSCAN clustering
                        </p>
                    </div>
                </div>
